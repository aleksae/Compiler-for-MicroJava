...
public class VariableDeclarationArray extends VarDecl {

    private Type Type;
    private VarName VarName;
    private VarDeclRepeat VarDeclRepeat;

    public VariableDeclarationArray (Type Type, VarName VarName, VarDeclRepeat VarDeclRepeat) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VariableDeclarationArray(\n");
