...
public class FormParamReg extends FormParams {

    private Type Type;
    private FormName FormName;
    private FormParamsRepeat FormParamsRepeat;

    public FormParamReg (Type Type, FormName FormName, FormParamsRepeat FormParamsRepeat) {
        this.Type=Type;
