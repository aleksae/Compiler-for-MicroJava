...
public class VarDeclarationRepeat extends VarDeclRepeat {

    private VarDeclRepeat VarDeclRepeat;
    private VarName VarName;

    public VarDeclarationRepeat (VarDeclRepeat VarDeclRepeat, VarName VarName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclarationRepeat(\n");
