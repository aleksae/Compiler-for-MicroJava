...
public class DesignatorStatementDepack extends DesignatorStatementPartTwo {

    private DesignatorComma DesignatorComma;
    private Designator Designator;
    private Designator Designator1;

    public DesignatorStatementDepack (DesignatorComma DesignatorComma, Designator Designator, Designator Designator1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementDepack(\n");
