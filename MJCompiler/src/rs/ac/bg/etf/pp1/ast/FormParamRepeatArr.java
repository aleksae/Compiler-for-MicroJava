...
public class FormParamRepeatArr extends FormParamsRepeat {

    private Type Type;
    private FormName FormName;
    private FormParamsRepeat FormParamsRepeat;

    public FormParamRepeatArr (Type Type, FormName FormName, FormParamsRepeat FormParamsRepeat) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParamRepeatArr(\n");
